...
# 이미지 메타데이터
IMAGE_DB = [
    {"file": "폭군_분노.png", "tags": "분노 위협 광기 폭군 살기 위험"},
    {"file": "폭군_의심.png", "tags": "의심 경계 불쾌 폭군 눈초리 경계심"},
    {"file": "폭군_호탕.png", "tags": "호탕 웃음 기분 좋음 술 유쾌"},
    {"file": "희종_0.png", "tags": "차갑고 슬픈 눈빛 경계 불신 유배지 외로움"},
    {"file": "희종_30.png", "tags": "조심스러운 표정 마음 열기 시작 어색함"},
    {"file": "희종_50.png", "tags": "신뢰 따뜻한 눈빛 마음 열린 왕 편안함"},
    {"file": "희종_70.png", "tags": "눈물 감동 복위 결심 백성 걱정 결의"},
]
